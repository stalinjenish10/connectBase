...
public class CreateDealNegativeTest {
  ...
  void InvalidInputParameterTest(Object companyId, Object extractedAccountId) {
    CreateDealAccountDetails createDealAccountDetails = AdvanceCpqV2TestData.getCreateDealAccountDetails();

    Response response =
      AdvanceCpqV2NegativeService.createDealAccountDetails(createDealAccountDetails, SESSION_TOKEN, companyId, extractedAccountId);
  ...
  void ResourceNotFoundTest(Object companyId, Object AccountId) {
    ...
    Response response =
      AdvanceCpqV2NegativeService.createDealAccountDetails(createDealAccountDetails, SESSION_TOKEN, companyId, AccountId);
