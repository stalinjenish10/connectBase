...
public class GetQuoteConfigNegativeTest {
  ...
  void InvalidParameterTest(Object companyId, Object AccountId, Object DealId) {
    Response response = AdvanceCpqV2NegativeService.getQuoteConfig(SESSION_TOKEN, companyId, AccountId, DealId);
  ...
  void ResourceNotFoundTest(Object companyId, Object AccountId, Object DealId) {
    ...
    if (Objects.equals(companyId, "900") & Objects.equals(AccountId, AccountId) & "456321458".equals(String.valueOf(DealId))) {
