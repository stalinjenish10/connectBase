...
import com.capestart.pojos.advancecpqv2.CreateOrderDetails;
...
public class CreateOrderNegativeTest {
  ...
  void InvalidParameterTest(Object companyId, Object QuoteId) {
    ...
    Response response = AdvanceCpqV2NegativeService.createOrder(createOrderDetails, SESSION_TOKEN, companyId, QuoteId);
