...
import com.capestart.pojos.advancecpqv2.UpdateDealAccountDetails;
import com.capestart.testdata.AdvanceCpqV2TestData;
import io.restassured.response.Response;
import org.testng.annotations.BeforeSuite;
import org.testng.annotations.Test;

public class UpdateDealNameNegativeTest {
  ...
  void InvalidParameterTest(Object companyId, Object AccountId, Object DealId) {
    ...
    UpdateDealAccountDetails updateDealAccountDetails = UpdateDealAccountDetails
      ...
      .build();
    Response response =
      AdvanceCpqV2NegativeService.updateDealAccountName(updateDealAccountDetails, SESSION_TOKEN, companyId, AccountId, DealId);
  ...
  void ResourceNotFoundTest(Object companyId, Object AccountId, Object DealId) {
    ...
    if ("900".equals(String.valueOf(companyId)) & AccountId.equals(String.valueOf(AccountId)) &
      ...
      message = "Unable to find dealId: 456321458";
