...
import com.capestart.pojos.advancecpqv2.CreatePricingDetails;
import com.capestart.testdata.AdvanceCpqV2TestData;
import io.restassured.response.Response;
import org.testng.annotations.BeforeSuite;
import org.testng.annotations.Test;

public class PostCreatePricingNegativeTest {
  ...
  void InvalidParameterTest(Object companyId, Object AccountId, Object DealId) {
    ...
    Response response =
      AdvanceCpqV2NegativeService.postCreatePricing(createPricingDetails, SESSION_TOKEN, companyId, AccountId, DealId);
