...
import com.capestart.pojos.advancecpqv2.CreateDealAccountDetails;
...
public class GetDealsNegativeTest {
  ...
  void InvalidParameterTest(Object companyId, Object AccountId) {
    Response response = AdvanceCpqV2NegativeService.getDealAccountDetails(SESSION_TOKEN, companyId, AccountId, true, false);
  ...
  void InvalidKeyUnauthorizedTest(Object COMPANY_ID, Object AccountId, boolean isPositive) throws IOException {
    Response response = AdvanceCpqV2NegativeService.getDealAccountDetails(SESSION_TOKEN, COMPANY_ID, AccountId, false, false);
  ...
  void AccessOtherUsersDataUnauthorizedTest(Object COMPANY_ID, Object Account_ID, boolean isPositive) throws IOException {
    Response response = AdvanceCpqV2NegativeService.getDealAccountDetails(SESSION_TOKEN, COMPANY_ID, Account_ID, false, true);
    response.then().log().all();
