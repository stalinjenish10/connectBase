...
public class GetSelectedPriceNegativeTest {
  ...
  @RateLimited(requestsPerSecond = 5)
  ...
  void InvalidParameterTest(Object companyId, Object QuoteId) {
    Response response = AdvanceCpqV2NegativeService.getSelectedPrice(SESSION_TOKEN, companyId, QuoteId);
