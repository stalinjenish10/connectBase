...
public class GetAccountListByIdNegativeTest {
  ...
  void InvalidParameterTest(Object companyId, Object accountId) {
    Response response = AdvanceCpqV2NegativeService.getAccountListById(SESSION_TOKEN, companyId, accountId, true, false);
  ...
  void InvalidKeyUnauthorizedTest(Object COMPANY_ID, Object AccountId, boolean isPositive) throws IOException {
    Response response = AdvanceCpqV2NegativeService.getAccountListById(SESSION_TOKEN, COMPANY_ID, AccountId, false, false);
  ...
  void AccessOtherUsersDataUnauthorizedTest(Object COMPANY_ID, Object Account_ID, boolean isPositive) throws IOException {
    Response response = AdvanceCpqV2NegativeService.getAccountListById(SESSION_TOKEN, COMPANY_ID, Account_ID, false, true);
    response.then().log().all();
