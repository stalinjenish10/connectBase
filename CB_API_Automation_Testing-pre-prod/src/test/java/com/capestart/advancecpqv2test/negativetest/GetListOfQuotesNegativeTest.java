...
public class GetListOfQuotesNegativeTest {
  ...
  void InvalidParameterTest(Object companyId, Object AccountId, Object DealId) {
    Response response = AdvanceCpqV2NegativeService.getListOfQuotes(SESSION_TOKEN, companyId, AccountId, DealId, true, false);
  ...
  void InvalidKeyUnauthorizedTest(Object COMPANY_ID, Object AccountId, Object dealId, boolean isPositive) throws IOException {
    Response response = AdvanceCpqV2NegativeService.getListOfQuotes(SESSION_TOKEN, COMPANY_ID, AccountId, dealId, false, false);
  ...
  void AccessOtherUsersDataUnauthorizedTest(Object COMPANY_ID, Object Account_ID, Object dealId, boolean isPositive)
    throws IOException {
    Response response = AdvanceCpqV2NegativeService.getListOfQuotes(SESSION_TOKEN, COMPANY_ID, Account_ID, dealId, false, true);
    response.then().log().all();
