...
public class GetTelcoNegativeTest {
  ...
  @Test(dataProvider = "Get All Test Data", dataProviderClass = NetworkIntelligenceV6DataProvider.class, invocationCount = 1)
  void InvalidParameterTest(Object latId, Object longtId, Object validationType) {
    Response response = NetworkIntelligenceV6NegativeService.getTelco(SESSION_TOKEN, latId, longtId, validationType);
  ...
  @Test(dataProvider = "Get All Test Data For 404", dataProviderClass = NetworkIntelligenceV6DataProvider.class)
  void ResourceNotFoundTest(Object latId, Object longtId, Object validationType) {
    Response response = NetworkIntelligenceV6NegativeService.getTelco(SESSION_TOKEN, latId, longtId, validationType);
    String responseBody = response.then().log().all().extract().asPrettyString();
    String message = null;
