...
public class GetBuildingProvidersByAddressNegativeTest {
  ...
  void InvalidParameterTest(Object companyId, Object addressParameter, Object validationType) {
    Response response =
      NetworkIntelligenceV6NegativeService.getBuildingProvidersByAddress(SESSION_TOKEN, companyId, addressParameter, validationType);
